...
class MusicRecommend extends StatefulWidget {
  const MusicRecommend({Key? key}) : super(key: key);

  @override
  State<MusicRecommend> createState() => _MusicRecommendState();
}

class _MusicRecommendState extends State<MusicRecommend> {
  bool _loading = false;
  ...
  Widget _buildPlayerContextWidget(BuildContext context) {
